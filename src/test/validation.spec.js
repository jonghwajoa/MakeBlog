...
describe('벨리데이션 함수 검증테스트......', () => {
  ...
  describe('isLength 함수는....', () => {
    let caseOne = 'abcde';
    it('input이 min값보다 작으면 false를 반환한다.', () => {
      isLength(caseOne, 10).should.be.false();
    });

    it('input이 min값보다 크면 true를 반환한다.', () => {
      isLength(caseOne, 3).should.be.true();
    });

    it('input값이 max값보다 크면 false를 반환한다..', () => {
      isLength(caseOne, 1, 3).should.be.false();
    });

    it('input값이 min값보다 크고 max값보다 작으면 true를 반환한다...', () => {
  ...
  describe('postValidation 함수는 ....', () => {
    ...
    it('category의 값이 없다면 false를 반환한다..', () => {
